    ...
    (level = $lvl:expr, $request:ident, $($field:tt)*) => {
        {
            ...
            let peer = $crate::root_span_macro::private::get_identified_peer($request);
            ...
            macro_rules! inner_span {
                ($level:expr) => {
                    $crate::root_span_macro::private::tracing::span!(
                        ...
                        client.address = %peer.peer(),
                        user_agent.original = %user_agent,
                        url.path = %$request.uri().path_and_query().map(|p| p.as_str()).unwrap_or(""),
                        http.response.status_code = $crate::root_span_macro::private::tracing::field::Empty,
                        ...
                        "http.response.header.content-type" = $crate::root_span_macro::private::tracing::field::Empty,
                        "http.response.header.content-encoding" = $crate::root_span_macro::private::tracing::field::Empty,
            ...
            let span = match $lvl {
                ::tracing::Level::TRACE => inner_span!(::tracing::Level::TRACE),
                ::tracing::Level::DEBUG => inner_span!(::tracing::Level::DEBUG),
                ::tracing::Level::INFO => inner_span!(::tracing::Level::INFO),
                ::tracing::Level::WARN => inner_span!(::tracing::Level::WARN),
                ::tracing::Level::ERROR => inner_span!(::tracing::Level::ERROR),
            };
...
pub mod private {
    ...
    pub fn get_identified_peer(request: &ServiceRequest) -> IdentifiedPeer {
        use actix_web::HttpMessage;
